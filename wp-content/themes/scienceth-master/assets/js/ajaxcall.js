        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.success) {
                    ...
                    window.location = registrationInfo.redirecturl;
                }
                if (data.errors.length > 0 || !data.success) {
                    // $('#registerModal').modal('show');
                    // window.location = registrationInfo.redirecturl + "/?loginMode=register";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.errors.length > 0 || !data.success) {
                    ...
                    // window.location = registrationInfo.redirecturl + "/?loginMode=login";
...
function validateRegisterData(password, username, email, firstname, lastname, confirmpassword) {
    var errors = [];
    if (!username.match(/^[a-zA-Z0-9@_-]+$/) || username.length < 3) {
