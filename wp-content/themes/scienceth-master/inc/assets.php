...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_enqueue_style('Y_frontpage', get_template_directory_uri() . '/assets/css/frontpage.css', [], Y_VERSION, 'all');
  ...
  wp_enqueue_script('Y_section2_script', get_template_directory_uri() . '/assets/js/section2.js', array('jquery'), NULL, true);
});
